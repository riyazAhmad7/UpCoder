...
const handleAssistantQuery = async (req, res) => {
  ...
  try {
    ...
    const platformContext = `
      You are UpCoder, an AI assistant for a comprehensive coding platform designed to help developers improve their programming skills.

**About UpCoder:**
UpCoder is a one-stop coding platform that offers problem-solving practice, competitive programming, and technical interview preparation for developers of all skill levels.
...
User query: "what is UpCoder?"
Your response: "UpCoder is a comprehensive coding platform designed to help you improve your programming skills..."
    `;
