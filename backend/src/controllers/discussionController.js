...
exports.createDiscussion = async (req, res) => {
  try {
    ...
    if (!title || !content || !community) {
      console.error("Missing required fields in createDiscussion:", {
        title,
        content,
        community,
      });
...
exports.getDiscussions = async (req, res) => {
  try {
    ...
    const discussions = await Discussion.find(query)
      ...
      .populate("author", "firstName lastName emailId profileImage")
      .lean();
...
exports.getDiscussionById = async (req, res) => {
  try {
    ...
    // Increment view count (simple increment for now)
    // TODO: Implement unique view tracking with user sessions
...
exports.updateDiscussion = async (req, res) => {
  try {
    ...
    await discussion.populate(
      "author",
      "firstName lastName emailId profileImage"
    );
