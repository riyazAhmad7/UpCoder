...
contestRouter.get(
  "/problems",
  adminMiddleware,
  contestController.getAllProblems
);
...
contestRouter.get(
  "/:contestId/status",
  userMiddleware,
  contestController.getContestStatus
);
...
contestRouter.post(
  "/:contestId/finalize",
  adminMiddleware,
  leaderboardController.finalizeContestRankings
);
contestRouter.get(
  "/user/history",
  userMiddleware,
  leaderboardController.getUserContestHistory
);
