...
const DiscussionCard = ({
  ...
  const isAuthor =
    currentUserId &&
    discussion.author &&
    (currentUserId === discussion.author._id ||
      currentUserId === discussion.author);
  ...
  return (
    <motion.div
      ...
      className={`bg-gray-800/50 border border-gray-700/50 rounded-xl p-5 transition-all cursor-pointer ${
        isSelected ? "border-orange-500" : "hover:border-gray-600"
      }`}
